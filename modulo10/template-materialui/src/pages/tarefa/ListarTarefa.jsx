...
const ListarTarefa = () => {
  ...
  useEffect(() => {
    filtroStatus === undefined
      ...
      : setTarefas(
          initialRows.filter(
            (atividade) => atividade.statusTarefa === filtroStatus
          )
        );
  }, [filtroStatus]);
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Button
            size="small"
            sx={{ marginRight: "10px" }}
            onClick={() => handleFiltrar("Em Andamento")}
            variant={`${
              filtroStatus === "Em Andamento" ? "contained" : "outlined"
            }`}
          >
            Em andamento
          </Button>
          <Button
            size="small"
            sx={{ marginRight: "10px" }}
            onClick={() => handleFiltrar("Concluída")}
            variant={`${
              filtroStatus === "Concluída" ? "contained" : "outlined"
            }`}
          >
            Concluída
          </Button>
          <Button
            size="small"
            sx={{ marginRight: "10px" }}
            onClick={() => handleFiltrar("Aguardando")}
            variant={`${
              filtroStatus === "Aguardando" ? "contained" : "outlined"
            }`}
          >
            Aguardando
          </Button>
